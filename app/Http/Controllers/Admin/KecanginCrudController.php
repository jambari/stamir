...
use App\Imports\KecanginsImport;
use Maatwebsite\Excel\Facades\Excel;
use Maatwebsite\Excel\Reader;
// VALIDATION: change the requests to match your own file names if you need form validation
use App\Http\Requests\KecanginRequest as StoreRequest;
use App\Http\Requests\KecanginRequest as UpdateRequest;
use Illuminate\Http\Request;
use Backpack\CRUD\CrudPanel;

use App\Models\Kecangin;
/**
 * Class HujanCrudController
 * @package App\Http\Controllers\Admin
 * @property-read CrudPanel $crud
 */
class KecanginCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Kecangin');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/kecangin');
        $this->crud->setEntityNameStrings('FF', 'semua FF');
...
// filter nama stasiun
        ...
        url('admin/kecangin/ajax-stasiun-options'), // the ajax route
        function($value) { // if the filter is active
    ...
    public function import(Request $request) 
    {
        ...
        Excel::import(new KecanginsImport, public_path('/uploads/'.$nama_file));
        \Alert::success(trans('backpack::crud.insert_success'))->flash();
        return redirect('/admin/kecangin')->with('success', 'Data berhasil terimport!');
    }
