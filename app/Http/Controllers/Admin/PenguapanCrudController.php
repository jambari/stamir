...
use App\Imports\PenguapansImport;
use Maatwebsite\Excel\Facades\Excel;
use Maatwebsite\Excel\Reader;
// VALIDATION: change the requests to match your own file names if you need form validation
use App\Http\Requests\PenguapanRequest as StoreRequest;
use App\Http\Requests\PenguapanRequest as UpdateRequest;
use Illuminate\Http\Request;
use Backpack\CRUD\CrudPanel;

use App\Models\Penguapan;
/**
 * Class HujanCrudController
 * @package App\Http\Controllers\Admin
 * @property-read CrudPanel $crud
 */
class PenguapanCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Penguapan');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/penguapan');
        $this->crud->setEntityNameStrings('EEE', 'semua EEE');
...
// filter nama stasiun
        ...
        url('admin/penguapan/ajax-stasiun-options'), // the ajax route
        function($value) { // if the filter is active
    ...
    public function import(Request $request) 
    {
        ...
        Excel::import(new PenguapansImport, public_path('/uploads/'.$nama_file));
        \Alert::success(trans('backpack::crud.insert_success'))->flash();
        return redirect('/admin/penguapan')->with('success', 'Data berhasil terimport!');
    }
